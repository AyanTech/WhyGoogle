...
class DirectionCareSwipeBackContainer(context: Context, attrs: AttributeSet? = null) :
    ...
    private fun handleInterceptTouchEvent(e: MotionEvent) {
        if (this@DirectionCareSwipeBackContainer.adapter?.itemCount == 1) {
    ...
    override fun onPageSettled(callback: SimpleCallBack) {
        this.registerOnPageChangeCallback(object :
            ...
            override fun onPageScrollStateChanged(state: Int) {
                ...
                isUserInputEnabled = this@DirectionCareSwipeBackContainer.adapter?.itemCount != 1
